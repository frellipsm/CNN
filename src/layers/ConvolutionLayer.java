...
public class ConvolutionLayer extends Layer{
    ...
    public ConvolutionLayer(int _filterSize, int _stepSize, int _inLength, int _inRows, int _inCols, int numFilters, double learningRate, long SEED) {
    ...
    public List<double[][]> convolutionForwardPass(List<double[][]>list){
        ...
        for (double[][] element : list){
            for (double[][] filter : _filters){
                output.add(convolve(element, filter, _stepSize));
            }
        }
        return output;
    }
